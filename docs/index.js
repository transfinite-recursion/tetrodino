...
Module['FS_createPath']("/", "assets", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/README.md", "start": 0, "end": 164}], "remote_package_size": 164});

  })();

// end include: /tmp/tmpmy6se0au.js
// include: /tmp/tmpprodlc79.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpprodlc79.js
// include: /tmp/tmp1g6dpr_u.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp1g6dpr_u.js
...
var ASM_CONSTS = {
 ...
 125610: () => { return parseInt(document.getElementById('canvas').style.width); },  
 125678: () => { document.exitFullscreen(); },  
 125705: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 125778: () => { if (document.fullscreenElement) return 1; },  
 125824: () => { return document.getElementById('canvas').width; },  
 125876: () => { return screen.width; },  
 125901: () => { document.exitFullscreen(); },  
 125928: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 126061: () => { return window.innerWidth; },  
 126087: () => { return window.innerHeight; },  
 126114: () => { if (document.fullscreenElement) return 1; },  
 126160: () => { return document.getElementById('canvas').width; },  
 126212: () => { return parseInt(document.getElementById('canvas').style.width); },  
 126280: () => { if (document.fullscreenElement) return 1; },  
 126326: () => { return document.getElementById('canvas').width; },  
 126378: () => { return screen.width; },  
 126403: () => { return window.innerWidth; },  
 126429: () => { return window.innerHeight; },  
 126456: () => { if (document.fullscreenElement) return 1; },  
 126502: () => { return document.getElementById('canvas').width; },  
 126554: () => { return screen.width; },  
 126579: () => { document.exitFullscreen(); },  
 126606: () => { if (document.fullscreenElement) return 1; },  
 126652: () => { return document.getElementById('canvas').width; },  
 126704: () => { return parseInt(document.getElementById('canvas').style.width); },  
 126772: () => { document.exitFullscreen(); },  
 126799: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 126857: () => { return screen.width; },  
 126882: () => { return screen.height; },  
 126908: () => { return window.screenX; },  
 126935: () => { return window.screenY; },  
 126962: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 127015: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 127086: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 127143: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 127399: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 127470: () => { if (document.fullscreenElement) return 1; },  
 127516: () => { return window.innerWidth; },  
 127542: () => { return window.innerHeight; },  
 127569: () => { if (document.pointerLockElement) return 1; }
};
...
function assignWasmExports(wasmExports) {
  ...
  Module['_main_update'] = _main_update = createExportWrapper('main_update', 1);
  Module['_main_end'] = _main_end = createExportWrapper('main_end', 1);
